...
//void mostrar(Cliente** arrayPunterosCliente, int cantidad) ES UN ARRAY DE PUNTEROS A CLIENTES
...
void mostrar(Cliente* arrayPunterosCliente[], int cantidad)
{
    ...
    for(i=0; i<cantidad; i++)
    {
        ...
        printf("\nNombre: %s" ,arrayPunterosCliente[i]->nombre);
        printf("\nID: %d" ,arrayPunterosCliente[i]->idCliente);
    }
}
